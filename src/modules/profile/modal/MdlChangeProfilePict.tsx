...
interface ProfilePicValuesTypes {
  file: any;
}
        ...
        <form action="" className="" onSubmit={handleSubmit(onSubmit)}>
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex max-w-xl justify-center">
              <button
                type="submit"
                className="py-3 px-14 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg text-center border border-transparent bg-blue-700 text-white hover:bg-blue-900 focus:outline-none focus:bg-blue-900 disabled:opacity-50 disabled:pointer-events-none dark:bg-white dark:text-neutral-800"
                disabled={loading}
              >
                {loading ? (
                  <>
